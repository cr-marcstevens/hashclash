...
void sha1_backward_differential_step(const hashclash::sha1differentialpath& path
...
public:
	path_container_autobalance()
		...
		, condcount(0), maxQ26upcond(1024), minweight(0)
		, fillfraction(0)
